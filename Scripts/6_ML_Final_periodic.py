...
save_path = os.path.join(BASE_DIR, "Outputs ML", "Only Spectra")
...
output_path = os.path.join(BASE_DIR, "Outputs ML", "Only Spectra")
...
# Load from saved CSV
csv_path = os.path.join(BASE_DIR, r"Outputs ML\Only Spectra\NestedCV_comparison_summary.csv")
...
# Save the figure
save_path = os.path.join(BASE_DIR, r"Outputs ML\Only Spectra\OnlyAccuracy_plot.png")
