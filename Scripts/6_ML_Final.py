...
save_path = os.path.join(BASE_DIR, "Outputs ML")
...
output_path = os.path.join(BASE_DIR, "Outputs ML")
...
# Load from saved CSV
csv_path = os.path.join(BASE_DIR, r"Outputs ML\NestedCV_comparison_summary.csv")
...
# Save the figure
save_path = os.path.join(BASE_DIR, r"Outputs ML\OnlyAccuracy_plot.png")
